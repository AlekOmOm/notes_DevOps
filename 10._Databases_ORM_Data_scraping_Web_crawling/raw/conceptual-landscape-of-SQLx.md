Okay, let's break down the conceptual landscape of SQLx, its interaction with Actix and Docker, and the specific challenges you're facing with SQLite vs. PostgreSQL in a CI/CD context.
